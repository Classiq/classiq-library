...
<img
  src="/qmod-reference/language-reference/statements/resources/simple_phase_circuit_bright.png"
  alt="visualization of the phase example bright"
  className="block dark:hidden"
/>
<img
  src="/qmod-reference/language-reference/statements/resources/simple_phase_circuit.png"
  alt="visualization of the phase example dark"
...
![simple_phase_exe_result.png](/qmod-reference/language-reference/statements/resources/simple_phase_exe_result.png)
