...
<img
  src="/qmod-reference/language-reference/statements/resources/within_apply_bright.png"
  alt="visualization of the within-apply example bright"
  className="block dark:hidden"
/>
<img
  src="/qmod-reference/language-reference/statements/resources/within_apply.png"
  alt="visualization of the within-apply example dark"
