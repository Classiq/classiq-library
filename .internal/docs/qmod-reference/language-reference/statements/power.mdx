...
<img
  src="/qmod-reference/language-reference/statements/resources/power_bright.png"
  alt="visualization of the power example bright"
  className="block dark:hidden"
/>
<img
  src="/qmod-reference/language-reference/statements/resources/power.png"
  alt="visualization of the power example dark"
