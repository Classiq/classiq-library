...
<img
  src="/qmod-reference/language-reference/statements/resources/xor_lsb_bright.png"
  alt="visualization of the bind example bright"
  className="block dark:hidden"
/>
<img
  src="/qmod-reference/language-reference/statements/resources/xor_lsb.png"
  alt="visualization of the bind example dark"
