...
thereof (see [classical types](/qmod-reference/language-reference/classical-types)).
...
expressions.
Classical variables can be declared as [function parameters](/qmod-reference/language-reference/functions) or
local variables.
...
[Execution parameters](/qmod-reference/language-reference/quantum-entry-point#model-execution-parameters) must
...
See the [mid-circuit measurement](/qmod-reference/language-reference/mid-circuit-measurement) documentation page
