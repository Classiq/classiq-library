...
[_within-apply_](/qmod-reference/language-reference/statements/within-apply) statement. Such variables are
...
When a variable is initialized inside the _within_ block of a [_within-apply_](/qmod-reference/language-reference/statements/within-apply)
...
<img
  src="/qmod-reference/language-reference/resources/auto_uncomputation_bright.png"
  alt="visualization of the automatic uncomputation example bright"
  className="block dark:hidden"
/>
<img
  src="/qmod-reference/language-reference/resources/auto_uncomputation.png"
  alt="visualization of the automatic uncomputation example dark"
