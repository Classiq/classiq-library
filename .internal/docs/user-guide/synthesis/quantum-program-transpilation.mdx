---
title: "Quantum Program Transpilation"
...
hierarchical quantum program in a meaningful way, the [analyzer web application](/user-guide/analysis/visualization-of-quantum-programs)
...
for the given hardware. Thus, the [Executor](/user-guide/execution/index) uses the
transpiled quantum program.

The [synthesis results](/user-guide/synthesis/getting-started#synthesis-results) include
both quantum programs, in all [output formats](/user-guide/synthesis/preferences#output-formats)
that you request. In addition, when using [hardware-aware synthesis](/user-guide/synthesis/hardware-aware-synthesis),
...
See [execution preferences](/user-guide/execution/index#execution-preferences').
