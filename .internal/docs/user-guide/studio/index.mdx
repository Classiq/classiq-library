---
title: "Studio - Web-based IDE with Classiq inside"
...
**Access the Studio** – Open the Studio from the [platform](https://platform.classiq.io/) (after registration) and follow the instructions [here](/user-guide/studio/Studio-Guide)
